...
#define MotoFlashHead  0x08003ccc//舵机flash存储头
...
//extern CircularBuffer VOEbuff;//USART1串口接收缓冲区
//extern CircularBuffer VOE2buff;//USART2串口接收缓冲区

extern u8 rxbuf_st[rx_buf_len]; 
extern u8 txbuf_st[rx_buf_len];
//extern u8 VOEbuff_st[rx_buf_len];//语音串口缓冲器接收
//extern u8 VOE2buff_st[rx_buf_len];//蓝牙串口缓冲器接收
